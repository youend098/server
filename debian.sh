...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome MF_youend ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green} MF_youend® ${NC}${YELLOW}(${NC} ${green} MF_youend ${NC}${YELLOW})${NC}"
echo -e " © Recode By MF_youend${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/youend098/register/main/reg | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/youend098/register/main/reg | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
# Status ExpiRED Active | MF_youend Project
Info="(${green}Active${NC})"
Error="(${RED}ExpiRED${NC})"
today=`date -d "0 days" +"%Y-%m-%d"`
Exp1=$(curl https://raw.githubusercontent.com/youend098/register/main/reg | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/youend098/server/main/"
...
echo -e "     \e[1;32m2)\e[0m Gunakan Domain Random Khusus Digital ocean ISP LAIN"
echo -e "   ------------------------------------"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/youend098/register/main/reg | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/youend098/register/main/reg | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ🐳","url":"https://t.me/MF_youend"},{"text":"ɪɴꜱᴛᴀʟʟ🐬","url":"https://t.me/MFyouendbot"}]]}'
...
wget raw.githubusercontent.com/youend098/server/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
